...
console.log("\n");
console.log(parser.parse("これはエラーになるべき)です").show_pemd())
parser.reset();
...
console.log("\n");
console.log(parser.parse("これはエラー、![command arg1 arg2 arg3| name").show_pemd())
parser.reset();

console.log("\n");
console.log(parser.parse("![command arg1 arg2 arg3 | name]").show_pemd())
parser.reset();
...
console.log("\n");
console.log(parser.parse("これは内容を含む![command](複雑なコマンドを持つ文章です。)").show_pemd())
parser.reset();

console.log("\n");
console.log(parser.parse("これは内容を含む![command arg1 arg2 arg3 ](複雑なコマンドを持つ文章です。)").show_pemd())
parser.reset();
...
console.log("\n");
console.log(parser.parse("これは内容を含む![command arg1 arg2 arg3 |name](複雑なコマンドを持つ文章です。)").show_pemd())
parser.reset();
